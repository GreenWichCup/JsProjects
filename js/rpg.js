...
var fontMap;
  ...
  var urlName= "http://localhost/js-gamev2/js/object.json";
        ...
        if (((playerArray[l][0] + 70 === playerArray[m][0] && playerArray[l][1] === playerArray[m][1]) || (playerArray[l][1] + 70 === playerArray[m][1] && playerArray[l][0] === playerArray[m][0])) || ((playerArray[l][0] - 70 === playerArray[m][0] && playerArray[l][1] === playerArray[m][1]) || (playerArray[l][1] - 70 === playerArray[m][1] && playerArray[l][0] === playerArray[m][0]))) {
            ...
            switch (key) {
                case 38:  // Flèche haut, z, w, Z, W
                    if (playerArray[l][1] > 0) { playerTurn[l].nextMove(1, 0, -70, DIRECTION.UP) };

                    break;
                case 40:  // Flèche bas, s, S

                    if (playerArray[l][1] < 350) { playerTurn[l].nextMove(1, 0, +70, DIRECTION.DOWN) };

                    break;
                case 37: // Flèche gauche, q, a, Q, A
                    ;
                    if (playerArray[l][0] > 0) { playerTurn[l].nextMove(0, 1, -70, DIRECTION.LEFT) };
                    break;
                case 39:  // Flèche droite, d, D
                    if (playerArray[l][0] < 630) { playerTurn[l].nextMove(0, 1, +70, DIRECTION.RIGHT) };
                    break;
